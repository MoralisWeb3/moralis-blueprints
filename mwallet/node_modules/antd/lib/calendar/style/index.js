...
var _style2 = require("../../input/style");
...
const genCalendarStyles = token => {
  ...
  return {
    [calendarCls]: Object.assign(Object.assign(Object.assign({}, (0, _style.genPanelStyle)(token)), (0, _style3.resetComponent)(token)), {
      background: fullBg,
      '&-rtl': {
        direction: 'rtl'
      },
...
var _default = (0, _internal.genComponentStyleHook)('Calendar', token => {
  ...
  const calendarToken = (0, _internal.mergeToken)((0, _style2.initInputToken)(token), (0, _style.initPickerPanelToken)(token), {
    calendarCls,
