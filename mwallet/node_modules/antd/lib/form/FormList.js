...
const FormList = _a => {
  ...
  process.env.NODE_ENV !== "production" ? (0, _warning.default)(typeof props.name === 'number' || (Array.isArray(props.name) ? !!props.name.length : !!props.name), 'Form.List', 'Miss `name` prop.') : void 0;
  const {
    getPrefixCls
